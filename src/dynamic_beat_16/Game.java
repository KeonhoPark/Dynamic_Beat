...
public class Game extends Thread {
    ...
    public void screenDraw(Graphics2D g) {
        ...
        g.drawImage(blueFlareImage, 230, 260, null);
    ...
    public void pressS() {
        judge("S");
        noteRouteSImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadSImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void pressD() {
        judge("D");
        noteRouteDImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadDImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void pressF() {
        judge("F");
        noteRouteFImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadFImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void pressSpace() {
        judge("Space");
        noteRouteSpace1Image = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadSpace1Image = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        noteRouteSpace2Image = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadSpace2Image = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_space.mp3", false).start();
    }
    ...
    public void pressJ() {
        judge("J");
        noteRouteJImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadJImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void pressK() {
        judge("K");
        noteRouteKImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadKImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void pressL() {
        judge("L");
        noteRouteLImage = new ImageIcon(Main.class.getResource("../images/note_route_pressed.png")).getImage();
        keyPadLImage = new ImageIcon(Main.class.getResource("../images/keypad_pressed.png")).getImage();
        new Music("drum_small_3.mp3", false).start();
    }
    ...
    public void dropNotes(String titleName) {
        ...
        } else if (titleName.equals("Dizaro - Caribbean vibes") && difficulty.equals("Easy")) {
            int startTime = 1000;
            beats = new Beat[]{
                    new Beat(startTime, "Space")
            };
        } else if (titleName.equals("Dizaro - Caribbean vibes") && difficulty.equals("Hard")) {
            int startTime = 1000;
            beats = new Beat[]{
                    new Beat(startTime, "Space")
            };
        } else if (titleName.equals("Glassette - Meizong") && difficulty.equals("Easy")) {
            int startTime = 1000;
            beats = new Beat[]{
                    new Beat(startTime, "Space")
            };
        } else if (titleName.equals("Glassette - Meizong") && difficulty.equals("Hard")) {
            int startTime = 1000;
            beats = new Beat[]{
                    new Beat(startTime, "Space")
            };
    ...
    public void judgeEvent(String judge){
        if(!judge.equals("None")){
            blueFlareImage = new ImageIcon(Main.class.getResource("../images/blue_flare.png")).getImage();
        }
